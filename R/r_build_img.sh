...
docker build  --build-arg UserId="${curr_uid}" --build-arg GroupId="${curr_gid}"   --build-arg UserName="${curr_userName}" --build-arg GroupName="${curr_groupName}"  --force-rm -t r_sdk  .
